...
Route::group(['middleware' => 'check.access:sales_report'], function () {
    ...
    Route::get('/admin/sales_reports/daily_sales/download-csv', [CvsExportController::class, 'downloadCsv'])->name('admin.sales_reports.download-csv');
    ...
    Route::get('/admin/sales_reports/daily_sales/download-excel', [CvsExportController::class, 'downloadExcel'])->name('admin.sales_reports.download-excel');
});
