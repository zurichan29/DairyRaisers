        ...
        <div class="mb-5 mt-16">
            ...
            <form>
                <input type="text" id="verification"
                    class="form-control py-1 px-2 rounded text-[#5f9ea0] font-semibold" placeholder="Verification code">
                <button type="button"
    ...
    <script>
        ...
        function sendOTP() {
            ...
            if (pattern.test(number)) {
                ...
                console.log(number); // Perform a request to check if the mobile number already exists in your database
                $.ajax({
