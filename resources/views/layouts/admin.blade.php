                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center justify-start">
                        ...
                        <a href="{{ route('admin.dashboard') }}" class="text-xl font-bold flex items-center lg:ml-2.5">
                            <img src="{{ asset('images/company-logo.png') }}" class="h-12 mr-2" alt="Logo">
                            <span class="self-center whitespace-nowrap">Dairy Raisers</span>
                        </a>
                    ...
                    <div class="flex items-center">
                        ...
                        <button id="dropdownAdmin" data-dropdown-toggle="dropdown"
                            class="hidden sm:inline-flex ml-5 space-x-4 text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm px-3 py-2 text-center items-center mr-3">
                            <img src="{{ asset('images/avatar-man.png') }}" class="w-8" alt="admin logo">
                            <p>Administrator</p>
                        </button>
                        <div id="dropdown"
                            class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 right-0">
                            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownAdmin">
                                <li>
                                    <a href="#"
        ...
        <div class="flex overflow-hidden bg-white pt-16">
                            ...
                            <ul class="space-y-2 pb-2">
                                ...
                                <li>
                                    <a href="{{ route('admin.dashboard') }}"
                                        class="text-base font-normal rounded-lg flex items-center p-2 text-white bg-gradient-to-r from-sky-600 to-cyan-400 hover:bg-gray-100 group">
                                    ...
                                    <ul id="dropdown-example" class="hidden py-2 space-y-2">
                                        <li>
                                            <a href="{{ route('admin.products.index') }}"
                                                class="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 pl-11">Inventory</a>
                                        </li>
                                        <li>
                                            <a href="{{ route('admin.products.variants') }}"
                                                class="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 pl-11">Variants</a>
                                        </li>
                                    </ul>
                                </li>
            ...
            <div id="main-content" class="h-full w-full bg-gray-50 relative overflow-y-auto lg:ml-64">
                ...
                <p class="text-center text-sm text-gray-500 my-10">
                    &copy; 2019-2021 <a href="#" class="hover:underline" target="_blank">General Trias Dairy
                        Raisers Multi-Purpose Cooperative</a>. All
                    rights
                    reserved.
                </p>
            </div>
