...
@section('content')
    <!-- Add this in your blade layout file or the specific view file -->
    ...
    <div class="container mx-auto px-4 py-8">
        <div class="bg-white rounded shadow-sm p-4">
            ...
            <div class="mb-4">
                ...
                <select name="product" id="product" class="form-select rounded-md border-gray-300">
            ...
            <div id="addStockFormContainer" class="hidden">
                <h2 class="text-xl font-bold mb-4">Add Product Stock</h2>
                <form id="addStockForm" action="{{ route('admin.product.stock.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="stock" id="stock_quantity"
